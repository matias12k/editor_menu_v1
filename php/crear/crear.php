...
<?php
    ...
    $js_file2 = "../../js/editar_texto/editar_texto.js";
    $css_file2 = "../../css/editar_texto/editar_texto.css";
?>
...
<head>
    ...
    <!-- Se agregan dinamicamente los scripts de js para el menu de editar_texto -->
    <script src="<?php echo $js_file2; ?>"></script>
    ...
    <div class="container">
        <div class="container__div1">
            ...
            <div id="estilos" class="estilos">
                <!-- Aquí se mostrará el contenido de editar_texto.php -->
            </div>
